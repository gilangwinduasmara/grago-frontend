...
const ThreadItem = ({id, replies, content, user, created_at, replies_count, attachment, parent_id}: Thread) => {
    return (
                                ...
                                <Link href={`/threads/${id}`}>
                                    <div className={'text-center bg-neutral-gray-100 text-neutral-gray-800 flex items-center justify-center py-2 rounded'}>
                                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 21.8042L12.5868 18H20.5C21.6046 18 22.5 17.1046 22.5 16V4C22.5 2.89543 21.6046 2 20.5 2H4.5C3.39543 2 2.5 2.89543 2.5 4V16C2.5 17.1046 3.39543 18 4.5 18H6.5V21.8042ZM12.0132 16L8.5 18.1958V16H4.5V4H20.5V16H12.0132Z" fill="#454646"/>
                                        </svg>
                                        {replies_count}
                                    </div>
                                </Link>
